...
function Xt(e, n, i = t) {
  let {
    ...
    p = (e) => (o ? e : I(e) || o === !1 || o === 0 ? Zt(e, 1) : Zt(e)),
    m,
    g,
    _,
    v,
  ...
  let C = b ? Array(e.length).fill(Kt) : Kt,
    w = (e) => {
      if (!(!(m.flags & 1) || (!m.dirty && !e)))
        if (n) {
          ...
          if (e || o || y || (b ? t.some((e, t) => D(e, C[t])) : D(t, C))) {
            ...
            Jt = m;
            try {
              let e = [t, C === Kt ? void 0 : b && C[0] === Kt ? [] : C, v];
              ((C = t), f ? f(n, 3, e) : n(...e));
            } finally {
              Jt = e;
            }
...
function Zt(e, t = 1 / 0, n) {
  if (
    ...
    return e;
  if ((n.set(e, t), t--, z(e))) Zt(e.value, t, n);
...
function ln(e) {
  if (!(e.flags & 1)) {
    let t = mn(e),
      n = H[H.length - 1];
    (!n || (!(e.flags & 2) && t >= mn(n)) ? H.push(e) : H.splice(cn(t), 0, e),
      (e.flags |= 1),
      un());
  }
}
...
var mn = (e) => (e.id == null ? (e.flags & 2 ? -1 : 1 / 0) : e.id);
function hn(e) {
  try {
...
function En(e, t, n) {
  let r = this.proxy,
    i = g(e) ? (e.includes(`.`) ? Dn(r, e) : () => r[e]) : e.bind(r, r),
    a;
...
function Vn(e, t, n = $) {
  ...
  if ((Un(t, r, n), n)) {
    let e = n.parent;
    for (; e && e.parent; )
      (Rn(e.parent.vnode) && Hn(r, t, n, e), (e = e.parent));
  }
}
function Hn(e, t, n, r) {
  let i = Un(t, e, r, !0);
...
var rr = (e) => (e ? (Ki(e) ? na(e) : rr(e.parent)) : null),
  ir = s(Object.create(null), {
    $: (e) => e,
    $el: (e) => e.vnode.el,
    $data: (e) => e.data,
    $props: (e) => e.props,
  ...
  ar = (e, n) => e !== t && !e.__isScriptSetup && u(e, n),
  or = {
    get({ _: e }, n) {
  ...
  return (
    s
      ...
      : !i.length && !n && !r
        ? (c = t)
        : ((c = {}),
          i.length && i.forEach((e) => mr(c, e, o, !0)),
          mr(c, t, o)),
    v(t) && a.set(t, c),
    c
  );
...
function br(e, t) {
  return e
    ? d(e) && d(t)
      ? [...new Set([...e, ...t])]
      : s(Object.create(null), sr(e), sr(t ?? {}))
    : t;
}
function xr(e, t) {
  if (!e) return t;
...
function jr(e) {
  ...
  if (y && g !== !1) {
    ...
    e.length &&
      t & 7 &&
      (a && e.some(o) && (y = Nr(y, a)), (b = ki(b, y, !1, !0)));
  }
  return (
    n.dirs &&
      ((b = ki(b, null, !1, !0)),
      (b.dirs = b.dirs ? b.dirs.concat(n.dirs) : n.dirs)),
    n.transition && jn(b, n.transition),
    (v = b),
    _n(_),
    v
  );
...
var Rr = {},
  zr = () => Object.create(Rr),
  Br = (e) => Object.getPrototypeOf(e) === Rr;
function Vr(e, t, n, r = !1) {
  let i = {},
    a = zr();
  ((e.propsDefaults = Object.create(null)), Ur(e, t, i, a));
...
var Jr = (e) => e === `_` || e === `_ctx` || e === `$stable`,
  Yr = (e) => (d(e) ? e.map(Ni) : [Ni(e)]),
  Xr = (e, t, n) => {
    if (t._n) return t;
    let r = vn((...e) => Yr(t(...e)), n);
    return ((r._c = !1), r);
...
function ri(e, i) {
  ...
  let {
    ...
    v = (
      ...
      if (e === t) return;
      (e && !wi(e, t) && ((r = ye(e)), k(e, i, a, !0), (e = null)),
      ...
      u != null && i
        ? Fn(u, e && e.ref, a, t || e, !t)
        : u == null && e && e.ref != null && Fn(e.ref, null, a, e, !0);
    },
    y = (e, t, n, r) => {
    ...
    te = (e, t, n, r, i, a, s, u) => {
      ...
      if (
        ...
        h & 8
          ? p(d, e.children)
          : h & 16 && T(e.children, d, null, r, i, ii(e, a), s, u),
        _ && yn(e, null, r, `created`),
        ne(d, e, e.scopeId, s, r),
        m)
      ) {
        for (let e in m) e !== `value` && !ee(e) && c(d, e, null, m[e], a, r);
        (`value` in m && c(d, `value`, null, m.value, a),
          (f = m.onVnodeBeforeMount) && Li(f, r, e));
      }
    ...
    ne = (e, t, n, r, i) => {
      ...
      if (i) {
        ...
        if (
          t === n ||
          (fi(n.type) && (n.ssContent === t || n.ssFallback === t))
        ) {
          let t = i.vnode;
    ...
    re = (e, n, r, i, a, o, s) => {
      ...
      if (
        ...
        r && ai(r, !0),
        d &&
          (!e.dynamicChildren || e.dynamicChildren.length !== d.length) &&
          ((u = 0), (s = !1), (d = null)),
        ((m.innerHTML && h.innerHTML == null) ||
          (m.textContent && h.textContent == null)) &&
          p(l, ``),
        d
          ? E(e.dynamicChildren, d, l, r, i, ii(n, a), o)
          : s || de(e, n, l, null, r, i, ii(n, a), o, !1),
        u > 0)
      ) {
      ...
      ((g = h.onVnodeUpdated) || f) &&
        K(() => {
          (g && Li(g, r, n, e), f && yn(n, e, r, `updated`));
        }, i);
    },
    E = (e, t, n, r, i, a, o) => {
      for (let s = 0; s < t.length; s++) {
        let c = e[s],
          l = t[s],
          u =
            c.el && (c.type === q || !wi(c, l) || c.shapeFlag & 198)
              ? m(c.el)
              : n;
        ...
        e == null
          ...
          : p > 0 &&
            ...
            ? (E(e.dynamicChildren, m, n, i, a, s, c),
              (t.key != null || (i && t === i.subTree)) && si(e, t, !0))
    ...
    O = (e, t, n, r, i, a, o) => {
      ...
      if ((Rn(e) && (s.ctx.renderer = xe), Ji(s, !1, o), s.asyncDep)) {
        if ((i && i.registerDep(s, ce, o), !e.el)) {
          let r = (s.subTree = Q(hi));
    ...
    ce = (e, t, n, r, i, a, o) => {
      let s = () => {
        if (e.isMounted) {
          ...
          (ai(e, !1),
            ...
            n && oe(n),
            (d = t.props && t.props.onVnodeBeforeUpdate) && Li(d, s, t, c),
            ai(e, !0));
          let f = jr(e),
            p = e.subTree;
          ((e.subTree = f),
          ...
          if (
            (ai(e, !1),
            l && oe(l),
            !m && (o = c && c.onVnodeBeforeMount) && Li(o, d, t),
            ai(e, !0),
            s && j)
          ) {
            let t = () => {
              ((e.subTree = jr(e)), j(s, e.subTree, e, i, null));
            };
          ...
          ((t.shapeFlag & 256 ||
            (d && Ln(d.vnode) && d.vnode.shapeFlag & 256)) &&
            e.a &&
            K(e.a, i),
            (e.isMounted = !0),
            (t = n = r = null));
      ...
      ((u.i = e), (u.id = e.uid), (c.scheduler = () => ln(u)), ai(e, !0), l());
    },
    ue = (e, t, n) => {
      t.component = e;
      let r = e.vnode.props;
      ...
      if (u > f) {
        if (u <= p) {
          let e = p + 1,
            n = e < d ? t[e].el : i;
          for (; u <= p; )
            (v(null, (t[u] = l ? Pi(t[u]) : Ni(t[u])), r, n, a, o, s, c, l),
              u++);
        }
    ...
    me = (e, t, n, r, i = null) => {
      ...
      if (r !== 2 && d & 1 && l)
        if (r === 0)
          l.persisted && !a[An]
            ? o(a, t, n)
            : (l.beforeEnter(a), o(a, t, n), K(() => l.enter(a), i));
        else {
    ...
    k = (e, t, n, r = !1, i = !1) => {
      ...
      let h = u & 1 && f,
        g = !Ln(e),
        _;
      if ((g && (_ = o && o.onVnodeBeforeUnmount) && Li(_, t, e), u & 6))
        _e(e.component, n, r);
      else {
        if (u & 128) {
  ...
  return (
    i && ([Se, j] = i(xe)),
    { render: A, hydrate: Se, createApp: wr(A, Se) }
  );
}
    ...
    for (let e = 0; e < r.length; e++) {
      ...
      (a.shapeFlag & 1 &&
        ...
        ((a.patchFlag <= 0 || a.patchFlag === 32) &&
          ((a = i[e] = Pi(i[e])), (a.el = t.el)),
        !n && a.patchFlag !== -2 && si(t, a)),
        a.type === mi &&
          (a.patchFlag === -1 && (a = i[e] = Pi(a)), (a.el = t.el)),
        a.type === hi && !a.el && (a.el = t.el));
    }
}
function ci(e) {
  let t = e.slice(),
...
function vi() {
  (_i.pop(), (J = _i[_i.length - 1] || null));
}
var yi = 1;
function bi(e, t = !1) {
  ((yi += e), e < 0 && J && t && (J.hasOnce = !0));
}
function xi(e) {
  return (
    (e.dynamicChildren = yi > 0 ? J || n : null),
    vi(),
    yi > 0 && J && J.push(e),
    e
  );
...
function X(e, t, n, r, i, a) {
  return xi(Z(e, t, n, r, i, a, !0));
}
function Si(e, t, n, r, i) {
  return xi(Q(e, t, n, r, i, !0));
}
function Ci(e) {
...
var Ti = ({ key: e }) => e ?? null,
  Ei = ({ ref: e, ref_key: t, ref_for: n }) => (
    typeof e == `number` && (e = `` + e),
    e == null ? null : g(e) || z(e) || h(e) ? { i: W, r: e, k: t, f: !!n } : e
  );
function Z(
  e,
  t = null,
...
function Di(e, t = null, n = null, r = 0, i = null, a = !1) {
  if (((!e || e === tr) && (e = hi), Ci(e))) {
    ...
    return (
      ...
      yi > 0 &&
        !a &&
        J &&
        (r.shapeFlag & 6 ? (J[J.indexOf(e)] = r) : J.push(r)),
      (r.patchFlag = -2),
      r
    );
  }
  ...
  let o = g(e) ? 1 : fi(e) ? 128 : kn(e) ? 64 : v(e) ? 4 : h(e) ? 2 : 0;
  return Z(e, t, n, r, i, o, a, !0);
}
function Oi(e) {
  return e ? (It(e) || Br(e) ? s({}, e) : e) : null;
}
...
function Mi(e = ``, t = !1) {
  return t ? (Y(), Si(hi, null, e)) : Q(hi, null, e);
}
function Ni(e) {
  ...
  if (t == null) t = null;
    ...
    if (r & 65) {
      ...
      !r && !Br(t)
        ...
        : r === 3 &&
          W &&
          (W.slots._ === 1 ? (t._ = 1) : ((t._ = 2), (e.patchFlag |= 1024)));
    }
  else if (h(t)) {
    if (r & 65) {
      Fi(e, { default: t });
    ...
    ((t = { default: t, _ctx: W }), (n = 32));
  } else ((t = String(t)), r & 64 ? ((n = 16), (t = [Ai(t)])) : (n = 8));
...
function Yi(e, t) {
  ...
  if (r) {
    ...
    let n = (e.setupContext = r.length > 1 ? ta(e) : null),
      i = Wi(e),
      a = Qt(r, e, 0, [e.props, n]),
      o = y(a);
    if ((Ve(), i(), (o || e.sp) && !Ln(e) && Mn(e), o)) {
      if ((a.then(Gi, Gi), t))
        return a
          .then((n) => {
            Xi(e, n, t);
...
function na(e) {
  return e.exposed
    ? (e.exposeProxy ||= new Proxy(Ut(Lt(e.exposed)), {
        get(t, n) {
...
var Pa = /(Once|Passive|Capture)$/,
  Fa = /^on:?(?:Once|Passive|Capture)$/;
function Ia(e) {
  let t, n;
  for (; (n = e.match(Pa)) && !Fa.test(e); )
    ((t ||= {}),
...
var Ga = s({ patchProp: Ha }, pa),
  Ka;
function qa() {
  return (Ka ||= ni(Ga));
}
var Ja = (...e) => {
  let t = qa().createApp(...e),
    { mount: n } = t;
  return (
    (t.mount = (e) => {
      let r = Xa(e);
...
var Za = [
  ...
  $a = [
    {
      ...
      items: [
        ...
        `Multi-page platforms & portals`,
        `SEO foundations & performance`,
  ...
  to = [
    {
      tag: `Stage 01`,
      title: `Idea`,
      text: `We shape the starting point, clarify the goal, and identify what the digital solution needs to achieve.`,
    },
    {
      tag: `Stage 02`,
      title: `Plan`,
      text: `We organize the content, structure, features, and technical requirements before production begins.`,
    },
    {
      tag: `Stage 03`,
      title: `Build`,
      text: `We develop the website, software, integration, or content system with clarity and long-term use in mind.`,
    },
    {
      tag: `Stage 04`,
      title: `Refine`,
      text: `We review the details, improve the experience, and make sure the solution fits the business need.`,
    },
    {
      tag: `Stage 05`,
      title: `Launch`,
      text: `We prepare the final version, support the launch, and make sure everything is ready to be shared professionally.`,
    },
  ],
  no = [
    {
  ...
  io = [
    {
      label: `Email`,
      href: `mailto:hello@spariostudio.com`,
      text: `hello@spariostudio.com`,
    },
    { label: `Studio`, text: `Available worldwide - remote first.` },
    { label: `Response Time`, text: `We reply within one business day.` },
  ],
  ao = {
    browser: `<rect x="3" y="5" width="18" height="14" rx="1.5"/><line x1="3" y1="9.5" x2="21" y2="9.5"/><circle cx="6.2" cy="7.2" r="0.7" fill="currentColor" stroke="none"/><circle cx="8.6" cy="7.2" r="0.7" fill="currentColor" stroke="none"/>`,
    integration: `<rect x="3" y="3" width="8" height="8" rx="1.5"/><rect x="13" y="13" width="8" height="8" rx="1.5"/><path d="M11 7h3a2 2 0 012 2v4M13 17H9a2 2 0 01-2-2v-4"/>`,
    brand: `<circle cx="8" cy="9" r="3"/><circle cx="16" cy="9" r="3"/><circle cx="12" cy="16" r="3"/>`,
    grid: `<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/>`,
    image: `<rect x="3" y="4" width="18" height="14" rx="1.5"/><path d="M3 15l5-5 4 4 3-3 6 6"/><circle cx="8" cy="9" r="1.4"/>`,
    check: `<circle cx="12" cy="12" r="9"/><path d="M8 12l3 3 6-6"/>`,
    layout: `<rect x="4" y="4" width="16" height="16" rx="2"/><path d="M4 10h16M10 10v10"/>`,
    target: `<path d="M12 3v6m0 12v-6m9-3h-6M3 12h6"/><circle cx="12" cy="12" r="2"/>`,
    instagram: `<rect x="4" y="4" width="16" height="16" rx="4"/><circle cx="12" cy="12" r="3.2"/><circle cx="16.8" cy="7.2" r="0.8" fill="currentColor" stroke="none"/>`,
    linkedin: `<rect x="4" y="4" width="16" height="16" rx="1.5"/><path d="M8 11v6M8 8v.01M12 17v-6M12 13.8c0-1.7 1-2.8 2.5-2.8s2.5 1 2.5 3v3"/>`,
  },
  oo = [`innerHTML`],
  so = {
    __name: `AppIcon`,
    props: {
      ...
      className: { type: String, default: `icon` },
    },
    setup(e) {
      let t = e,
        n = ia(() => ao[t.name] || ``);
  ...
  co = { class: `section on-navy`, id: `approach` },
  lo = { class: `wrap how-grid` },
  uo = { class: `how-list` },
  fo = { class: `step` },
  po = {
    __name: `ApproachSection`,
    setup(e) {
      return (e, t) => (
        Y(),
        X(`section`, co, [
          Z(`div`, lo, [
            (t[0] ||= Z(
              ...
              null,
              [
                Z(`span`, { class: `eyebrow` }, `How We Work`),
                Z(`h2`, { class: `mt-16` }, [
                  Ai(`Clear steps, `),
                  Z(`em`, null, `practical progress.`),
                ]),
                Z(
                  `p`,
                  { class: `desc mt-22` },
                  `Every project moves through a structured process, so the direction, details, build, refinement, and launch are connected from the start.`,
                ),
              ],
              -1,
            )),
            Z(`div`, uo, [
              ...
              X(
                ...
                nr(
                  ...
                  (e) => (
                    Y(),
                    X(`div`, { key: e.step, class: `how-item` }, [
                      Z(`span`, fo, A(e.step), 1),
                      Q(so, { name: e.icon }, null, 8, [`name`]),
                      Z(`div`, null, [
                        Z(`h4`, null, A(e.title), 1),
                        Z(`p`, null, A(e.text), 1),
                      ]),
                    ])
                  ),
  ...
  mo = { class: `section contact-section`, id: `contact` },
  ho = { class: `wrap contact-wrap` },
  go = { class: `contact-info` },
  _o = { class: `contact-detail` },
  vo = { class: `label` },
  yo = [`href`],
  bo = { key: 1 },
  xo = {
    ...
    setup(e) {
      ...
      return (e, n) => (
        ...
        X(`section`, mo, [
          Z(`div`, ho, [
            Z(`div`, go, [
              (n[0] ||= Z(`span`, { class: `eyebrow` }, `Get In Touch`, -1)),
              (n[1] ||= Z(`h2`, null, `Tell us about your business.`, -1)),
              (n[2] ||= Z(
                `p`,
                { class: `desc` },
                `Share a few details about where you are and what you need, and we'll come back with next steps and a rough plan - no obligation.`,
                -1,
              )),
              Z(`div`, _o, [
                (Y(!0),
                X(
                  ...
                  nr(
                    ...
                    (e) => (
                      Y(),
                      X(`div`, { key: e.label }, [
                        Z(`span`, vo, A(e.label), 1),
                        e.href
                          ? (Y(),
                            X(`a`, { key: 0, href: e.href }, A(e.text), 9, yo))
                          : (Y(), X(`p`, bo, A(e.text), 1)),
                      ])
                    ),
                  ),
  ...
  So = `/assets/mark-dark-CY_HNcZ-.png`,
  Co = `/assets/mark-light-DDdJJynO.png`,
  wo = `/assets/logo-panel-dark-CMh0MYH8.png`,
  To = `/assets/logo-panel-light-ZcS0BTgQ.png`,
  Eo = `/assets/dark%20woodmark-transparent-Mn8wB4A7.png`,
  Do = [`src`],
  Oo = {
    __name: `Monogram`,
    props: {
      className: { type: String, default: `monogram` },
      variant: { type: String, default: `markLight` },
    },
    setup(e) {
      let t = e,
        n = {
      ...
      return (r, i) => (
        ...
        X(
          ...
          {
            class: k(e.className),
            src: n[t.variant] || B(`/assets/mark-light-DDdJJynO.png`),
            alt: ``,
            "aria-hidden": `true`,
          },
          null,
    ...
    setup(e) {
      return (e, t) => (
        ...
        X(`section`, ko, [
          Z(`div`, Ao, [
            Q(Oo, {
              "class-name": `cta-logo-mark`,
              variant: `transparentDark`,
            }),
            (t[0] ||= Z(
              `h2`,
              null,
              [Ai(`Have a project in mind? `), Z(`em`, null, `Let's talk.`)],
              -1,
            )),
            (t[1] ||= Z(
              `p`,
              null,
              `Tell us about your business and where you want to go. We'll come back with a plan tailored to it.`,
              -1,
            )),
            (t[2] ||= Z(
              `a`,
  ...
  Io = {
    ...
    props: {
      eyebrow: { type: String, required: !0 },
    ...
    setup(e) {
      return (t, n) => (
        Y(),
        X(`div`, Mo, [
          Z(`span`, No, A(e.eyebrow), 1),
          Z(`h2`, { class: `mt-16`, innerHTML: e.title }, null, 8, Po),
          e.description ? (Y(), X(`p`, Fo, A(e.description), 1)) : Mi(``, !0),
        ])
      );
    },
  },
  Lo = { class: `section`, id: `faq` },
  Ro = { class: `wrap` },
  zo = { class: `faq-list` },
  Bo = [`open`],
  Vo = {
              ...
              X(
                ...
                nr(
                  ...
                  (e) => (
                    ...
                    X(
                      `details`,
                      { key: e.question, open: e.open },
                      [
                        Z(`summary`, null, [
                          Ai(A(e.question) + ` `, 1),
                          (t[0] ||= Z(`span`, { class: `plus` }, `+`, -1)),
                        ]),
                        Z(`p`, null, A(e.answer), 1),
                      ],
                      8,
                      Bo,
                    )
  ...
  Ho = `/assets/laptop-notes-D5-0d_B6.jpg`,
  Uo = { class: `hero`, id: `top` },
  Wo = { class: `hero-inner` },
  Go = {
    class: `hero-visual`,
    role: `img`,
    "aria-label": `Workspace with a laptop, notes, and coffee`,
  },
  Ko = [`src`],
  qo = { class: `frame` },
  Jo = {
    ...
    setup(e) {
      return (e, t) => (
        ...
        X(`section`, Uo, [
          Z(`div`, Wo, [
            (t[0] ||= ji(
              `<div><span class="eyebrow">A Digital Studio · Est. 2026</span><h1>Custom digital solutions,<br><em>from idea to launch.</em></h1><p class="lede">Spario Studio helps businesses build websites, custom software, integrations, and content through a clear, complete, and practical process.</p><p class="lede lede-secondary">From planning and structure to development, refinement, and launch - we create digital solutions designed around your business needs.</p><div class="cta-row"><a href="#contact" class="btn btn-solid">Start a Project</a><a href="#contact" class="btn btn-outline">Contact Us</a></div></div>`,
              1,
            )),
            Z(`div`, Go, [
              Z(
                `img`,
                { class: `hero-visual-image`, src: B(Ho), alt: `` },
                null,
                8,
                Ko,
              ),
      ...
      return (e, t) => (
        ...
        X(`section`, Yo, [
          Z(`div`, Xo, [
            Q(Io, {
              eyebrow: `The Process`,
              title: `From idea to launch, one organized path forward.`,
            }),
            Z(`div`, Zo, [
              (Y(!0),
              X(
                ...
                nr(
                  ...
                  (e) => (
                    Y(),
                    X(`div`, { key: e.tag, class: `stage` }, [
                      Z(`span`, Qo, A(e.tag), 1),
                      Z(`h3`, null, A(e.title), 1),
                      Z(`p`, null, A(e.text), 1),
                    ])
                  ),
                ),
  ...
  es = { class: `section`, id: `services` },
  ts = { class: `wrap` },
  ns = { class: `services-grid` },
  rs = { class: `num` },
  is = { class: `row-desc` },
  as = {
    ...
    setup(e) {
      return (e, t) => (
        ...
        X(`section`, es, [
          Z(`div`, ts, [
            (t[0] ||= ji(
              `<div class="section-head services-head"><div class="head-row"><div><span class="eyebrow">What We Do</span><h2 class="mt-16">Services</h2></div><a href="#contact" class="jump">All Services -&gt;</a></div></div>`,
              1,
            )),
            Z(`div`, ns, [
              (Y(!0),
              X(
                ...
                nr(
                  ...
                  (e) => (
                    Y(),
                    X(`article`, { key: e.number, class: `service-card` }, [
                      Z(`span`, rs, A(e.number), 1),
                      Z(`h3`, null, A(e.title), 1),
                      Z(`p`, is, A(e.description), 1),
                    ])
                  ),
                ),
                128,
  ...
  os = `/assets/logo-horizontal-dark-DJczSg4P.png`,
  ss = `/assets/logo-horizontal-light-CrkBxNtf.png`,
  cs = { href: `#top`, class: `mark`, "aria-label": `Spario Studio home` },
  ls = [`src`],
  us = {
    __name: `BrandMark`,
    props: { variant: { type: String, default: `light` } },
    setup(e) {
      let t = e,
        n = { light: ss, dark: os };
      return (e, r) => (
        ...
        X(`a`, cs, [
          Z(
            `img`,
            {
              class: `mark-logo`,
              src:
                n[t.variant] || B(`/assets/logo-horizontal-light-CrkBxNtf.png`),
              alt: ``,
              "aria-hidden": `true`,
            },
            null,
  ...
  ds = { class: `wrap footer-top` },
  fs = { class: `footer-col` },
  ps = [`href`],
  ms = { class: `footer-col` },
  hs = { class: `social-links`, "aria-label": `Social links` },
  gs = { href: `https://www.instagram.com/`, "aria-label": `Instagram` },
  _s = { href: `https://www.linkedin.com/`, "aria-label": `LinkedIn` },
  vs = {
    __name: `SiteFooter`,
    setup(e) {
      let t = Za.filter((e) => e.label !== `Home`);
      return (e, n) => (
        Y(),
        X(`footer`, null, [
          Z(`div`, ds, [
            Z(`div`, null, [
              ...
              (n[0] ||= Z(
                `p`,
                null,
                `A digital studio building websites, software, and the systems behind them, for businesses ready to be taken seriously online.`,
                -1,
              )),
            ]),
            Z(`div`, fs, [
              (n[1] ||= Z(`h5`, null, `Studio`, -1)),
              (Y(!0),
              X(
                q,
                null,
                nr(
                  ...
                  (e) => (
                    Y(),
                    X(`a`, { key: e.href, href: e.href }, A(e.label), 9, ps)
                  ),
                ),
                128,
              )),
            ...
            Z(`div`, ms, [
              (n[2] ||= Z(`h5`, null, `Get In Touch`, -1)),
              (n[3] ||= Z(
                `a`,
                { href: `mailto:hello@spariostudio.com` },
                `hello@spariostudio.com`,
                -1,
              )),
              (n[4] ||= Z(
                `p`,
              ...
              Z(`div`, hs, [
                Z(`a`, gs, [
                  Q(so, { name: `instagram`, "class-name": `social-icon` }),
                ]),
                Z(`a`, _s, [
                  Q(so, { name: `linkedin`, "class-name": `social-icon` }),
                ]),
              ]),
              (n[5] ||= Z(
                `a`,
                { href: `#contact`, class: `btn btn-outline footer-button` },
                `Start a Project ->`,
                -1,
              )),
            ]),
          ...
          (n[6] ||= Z(
            `div`,
            { class: `wrap footer-bottom` },
            [
              Z(`span`, null, `© 2026 Spario Studio. All rights reserved.`),
              Z(`span`, null, `Websites · Software · Content`),
            ],
            -1,
          )),
        ])
      ...
      return (e, i) => (
        ...
        X(`header`, ys, [
          Z(`div`, bs, [
            ...
            Z(
              `nav`,
              { class: k([`primary`, { open: t.value }]), id: `primaryNav` },
              [
                (Y(!0),
                X(
                  q,
                ...
                Z(
                  `a`,
                  { href: `#contact`, class: `btn btn-solid`, onClick: r },
                  `Start a Project`,
                ),
              ],
              2,
  ...
  ws = { class: `section studio`, id: `studio` },
  Ts = {
    ...
    setup(e) {
      return (e, t) => (
        ...
        X(`section`, ws, [
          ...(t[0] ||= [
            ji(
              `<div class="wrap"><div class="studio-grid"><div><span class="eyebrow">The Studio</span></div><div><h2>From first idea to final launch, the pieces are shaped <em>together.</em></h2><p class="desc">Spario Studio works with businesses from the first idea to the final launch. Whether you need a website, custom software, an integration, or content for your digital presence, we help shape the concept, plan the structure, build the solution, refine the details, and prepare everything for launch.</p><p class="desc">The goal is to make the process clear, organized, and practical - so you are not left trying to connect the pieces on your own.</p></div></div></div>`,
              1,
            ),
          ]),
        ])
  ...
  Es = { class: `section testimonials-section`, id: `testimonials` },
  Ds = { class: `wrap` },
  Os = { class: `testimonials-head` },
  ks = { class: `testimonial-grid` },
  As = { class: `quote` },
  js = { class: `testimonial-source` },
  Ms = {
            ...
            Z(`div`, ks, [
              ...
              X(
                ...
                nr(
                  ...
                  (e) => (
                    Y(),
                    X(`article`, { key: e.quote, class: `testimonial-card` }, [
                      Z(`p`, As, `“` + A(e.quote) + `”`, 1),
                      Z(`div`, js, [
                        Z(`span`, null, A(e.name), 1),
                        Z(`small`, null, A(e.company), 1),
                      ]),
                    ])
                  ),
                ),
